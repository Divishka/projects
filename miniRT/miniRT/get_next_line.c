...
/*   Updated: 2021/05/13 09:52:44 by awhana           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	error_free(char *remains, char *buf, int i)
{
	if (remains != NULL)
		free(remains);
	if (buf != NULL)
...
static int	search_for_n(char **remains, char **line)
{
	char		*pointer;
	char		*temp;
...
static int	parse(t_args p, char **remains, char **line, char *buf)
{
