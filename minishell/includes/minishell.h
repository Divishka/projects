...
int					ft_pos_env(t_data *data, char *str);
...
int					ft_redirect(t_pars *pars, t_fdesk *fd);
void				ft_pipe_open(t_pars *pars, t_fdesk *fd);
void				ft_pipe_close(t_pars *pars, t_fdesk *fd);
void				ft_binar_subsidiary(t_data *data, t_pars *pars);
int					ft_binar_command(t_data *data, t_pars *pars);
int					ft_command_err(char *name_f);
int					ft_output_err(int code, char *str1, char *str2,
						char *str3);
int					ft_chrstr_in_set(char *str, char *set, int n);
int					ft_choice_command(t_data *data);
...
int					ft_build_in(t_data *data, t_pars *pars);
void				ft_build_open(t_fdesk *fd, int *fd_st0, int *fd_st1);
void				ft_build_close(t_fdesk *fd, int *fd_st0, int *fd_st1);
